...
#if FLOW_CONTROL
    REG_SIOCNT = uart | SIO_CTS | SIO_LENGTH_8 | SIO_SEND_ENABLE | SIO_RECV_ENABLE | SIO_USE_UART;
#else
    REG_SIOCNT = uart | SIO_LENGTH_8 | SIO_SEND_ENABLE | SIO_RECV_ENABLE | SIO_USE_UART;
#endif
...
void setInterupt()
{
    ...
    irq_add(II_VBLANK, update_frame_counter);
}
...
void waitVBlank() { VBlankIntrWait(); }
