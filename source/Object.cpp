...
u16 Object::getX() { return get_object_position_x(this->obj_att); }

void Object::setX(u16 x) { return set_object_position_x(this->obj_att, x); }

u16 Object::getY() { return get_object_position_y(this->obj_att); }

void Object::setY(u16 y) { set_object_position_y(this->obj_att, y); }
...
void Object::setTileIndex(u16 tile_index) { set_object_tile(this->obj_att, tile_index); }

void Object::setPaletIndex(u16 palet_index) { set_object_palet(this->obj_att, palet_index); }
