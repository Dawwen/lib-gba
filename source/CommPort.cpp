...
void resetPort() { REG_CNT = 0; }

// Pin Mode

void setPinMode() { REG_CNT = 0xc000; }
...
u32 readPins() { return REG_CNT & 0b1111; }

void setPin(Pin pin, InOut input) { REG_CNT = (REG_CNT & ~(1 << (pin + 4))) | (input << (pin + 4)); }
